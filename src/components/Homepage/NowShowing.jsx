    ...
    <div className="now-showing">
      ...
      <div className="map-showing">
          ...
          <div className="each-movie-showing" key={index}>
             <NavLink to={`/home/${movie.title}`} onClick={() => {dispatch(renderEachMovie(movie.ids))}}>
      ...
      <div><button className="hollow-button btn-now-showing" onClick={() => setState(state+6)}>View More</button></div>
